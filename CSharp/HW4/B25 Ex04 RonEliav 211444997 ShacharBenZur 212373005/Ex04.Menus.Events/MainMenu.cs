...
// $G$ DSN-004 (-5) Redundant code duplication (menu items list). You should have used polymorphism.
...
namespace Ex04.Menus.Events
{
    public class MainMenu
    {
        ...
        private const string k_MainMenuNameSticker = "** Delegates Main Menu **";
