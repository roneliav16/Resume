using System.Linq;
using System.Text;
// $G$ SFN-019 (-40) The program "Numbers statistics" is disqualified because it uses capabilities not taught in class, such as LINQ and lambda expressions.

namespace Ex01_05
{
    public class NumberStatistics
    {
        // $G$ DSN-003 (-5) The code of this method should be divided to few methods. 
